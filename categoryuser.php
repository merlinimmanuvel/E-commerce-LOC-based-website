    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
              <?php $sql=mysqli_query($db,"select id,subcategory  from subcategory where categoryid='$cid'");

while($row=mysqli_fetch_array($sql))
{
    ?>
                <a href="sub-categoryuser.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>
...
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title">Trends</h4>
	</div>
		...
		<div class="accordion">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="categoryuser.php?cid=<?php echo $row['id'];?>"  class="accordion-toggle collapsed">
				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=mysqli_query($db,"select categoryName  from category where id='$cid'");
while($row=mysqli_fetch_array($sql))
{
    ?>
...
{?>							
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="product-detail.php?pid=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['productName']);?></a></h3>
