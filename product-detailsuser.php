...
{
mysqli_query($db,"insert into wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	mysqli_query($db,"insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Product Address :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<?php if(strlen($_SESSION['login'])==0)
	...
	else
	{
		...
		?><div class="product-image">
			<div class="image">
				<a href="product-detailsuser.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productName']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
	...
	?>
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="product-detailsuser.php?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			<div class="rating rateit-small"></div>
